...
export const LocationServiceGrid: React.FC<LocationServiceGridProps> = ({
  ...
  // Filter only services connected through supportedServices relationship
    ...
    <section className="w-full bg-surface-subtle py-20 lg:py-28 border-b border-border text-brand-black">
      <Container>
        <SectionHeading
          ...
          title={`Cargo & Shipping Services in ${cityName}`}
          subtitle={`Commercial freight modes and logistics shipping options supported for dispatch from ${cityName}.`}
          className="mb-14"
        />

        {/* Editorial Service Rows with Row Dividers */}
